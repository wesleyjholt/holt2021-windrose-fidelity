"""
    run_opt(final_layout_path, opt_info_directory, layout_param, model_param, opt_algorithm::SnoptWECAlgorithm, boundary::CircleBoundary)
...
"""
function run_opt(final_layout_path, opt_info_directory, layout_param, model_param, opt_algorithm::SnoptWECAlgorithm, boundary::CircleBoundary)
    ...
    try mkdir(opt_info_directory); catch; end

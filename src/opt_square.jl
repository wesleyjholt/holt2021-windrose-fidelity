#=
AUTHOR: Wesley Holt
PURPOSE: Optimizes the turbine coordinates for a circular wind farm.
=#
...
########################################################################################################
# INPUT ARGUMENTS: number of directions, number of turbines, boundary_radius, layout_number, wake model
########################################################################################################
...
final_layout_directory = "final-layouts/"* nturbines_string * "turb/circle/" * boundary_radius_string * "r/" * wake_model * "/snopt-wec/" * ndirs * "dirs/"

...
# function generate_random_layout(layout_path, nturbines, rotor_diameter, boundary::CircleBoundary; min_spacing=1.0)
...
#             locations[i,:] = (rand(1,2) .- 0.5).*[xrange[2]-xrange[1] yrange[2]-yrange[1]] .+ boundary.center
...
# layout_directory = "initial-layouts/" * string(nturbines) * "turb-circle-" * string(Int(boundary_radius)) * "r/"
# figure_directory = "initial-layouts/" * string(nturbines) * "turb-circle-" * string(Int(boundary_radius)) * "r-figures/"
